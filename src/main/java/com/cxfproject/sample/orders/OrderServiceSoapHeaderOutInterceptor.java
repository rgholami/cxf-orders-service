...
public class OrderServiceSoapHeaderOutInterceptor extends
	...
	public void handleMessage(SoapMessage message) throws Fault {
		// Create a qualified name using the orders web service namespace and
		// the
		...
		try {
			// Create a new soap header instance using the qualified name,
			// apikey
			// and a JAXB data binding for the apikey string.
			SoapHeader header = new SoapHeader(qname, apikey,
					new JAXBDataBinding(apikey.getClass()));
